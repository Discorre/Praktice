...
int main() {
    ...
    //MyHashMap<std::string, MyVector<std::string>> jsonStructure(10, 50);//CreateMap<string, MyVector<string>*>(10, 50);  // Создаем хэш-таблицу для структуры JSON
    MyHashMap<std::string, MyVector<std::string>*>* jsonStructure = new MyHashMap<std::string, MyVector<std::string>*>(10, 50);
    ...
    //jsonStructure.DestroyMap();//<string, MyVector<string>*>(*jsonStructure);  // Освобождаем память
    delete jsonStructure;
